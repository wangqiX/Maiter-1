...
namespace dsm {
    ...
    class CTypedTable : virtual public UntypedTable {
    public:
        virtual bool contains(const K &k) = 0;
        virtual V1 get(const K &k) = 0;
        virtual vector<int> getV(const K&k) = 0;
        virtual void put(const K &k, const V1 &v1, vector<int> &vec) = 0;
    ...
    public:
        ...
        virtual void putc(const K &k, const V1 &v1, V3 &v3, int shard) = 0;
        virtual void put(const K &k, const V1 &v1, const V2 &v2, const V3 &v3) = 0;
        virtual void put2(const K &k, const V1 &v1, const V2 &v2, const V3 &v3) = 0;
        virtual void setCopy(const K&k) = 0;
        virtual void setNoCopy(const K&k) = 0;
        ...
        virtual void accumulateFFF(const K &k, const V1 &v, int shard) = 0;
        virtual void accumulateFF(const K &k, const V1 &v, int shard) = 0;
    ...
    template <class K, class V1>
    struct CTypedTableIterator : public TableIterator {
        virtual const K& key() = 0;
        virtual V1& value1() = 0;
